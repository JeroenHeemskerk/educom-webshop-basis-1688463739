    ...
    <!- Inputfields ->
                    <div>
                        <div class="form_group">
                            ...
                            <span class="error">* ' . getArrayVal($data["errors"], "name") . '</span>
                        </div>
                        <div  class="form_group">
                            <label class="form_label" for="email">Email</label>
                            <input class="form_response" type="text" id="email" name="email" value="' . getArrayVal($data["values"], "email") . '">
                            <span class="error">* ' . getArrayVal($data["errors"], "email") . '</span>
                        </div>
                        <div class="form_group">
                        ...
                        <div class="form_group">
                            ...
                            <span class="error">* ' . getArrayVal($data["errors"], "subject") . '</span>
                        </div>
                    </div>
    <!- Communication preference ->
                    <div class="form_group">
                        <label id="comm_pref" class="form_label" for="comm_pref">Communication preference:</label>
                        <span class="error">* ' . getArrayVal($data["errors"], "comm_pref") . '</span>
                        <div class="form_group">
    ...
    <!- Message ->
                    <div class="form_group">
                        ...
                        <div class="form_group">
                            ...
                            <span class="error">* ' . getArrayVal($data["errors"], "message") . '</span>
                        </div>
                    </div>
    <!- Submit button ->
